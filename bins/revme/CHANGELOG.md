...
## [0.9.0](https://github.com/rkrasiuk/revm/compare/revme-v0.8.0...revme-v0.9.0) - 2024-07-26

### Added
- *(EOF)* Add EOF validation in revme bytecode cmd ([#1660](https://github.com/rkrasiuk/revm/pull/1660))
...
- *(statetest)* Add back Merge spec ([#1658](https://github.com/rkrasiuk/revm/pull/1658))
