...
## [5.0.0](https://github.com/rkrasiuk/revm/compare/revm-primitives-v4.0.0...revm-primitives-v5.0.0) - 2024-05-16
...
### Fixed
- *(primitives)* specify the optimism cfg on spec_to_generic ([#1412](https://github.com/rkrasiuk/revm/pull/1412))
