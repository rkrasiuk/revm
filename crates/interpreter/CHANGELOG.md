...
## [4.0.0](https://github.com/rkrasiuk/revm/compare/revm-interpreter-v3.4.0...revm-interpreter-v4.0.0) - 2024-03-31

### Added
- derive serde for OpCode, improve implementations ([#1215](https://github.com/rkrasiuk/revm/pull/1215))
- *(interpreter)* expose mutable access methods on stack and memory ([#1219](https://github.com/rkrasiuk/revm/pull/1219))

### Other
- move div by zero check from smod to i256_mod ([#1248](https://github.com/rkrasiuk/revm/pull/1248))
...
- *(interpreter)* don't run signextend with 31 too ([#1222](https://github.com/rkrasiuk/revm/pull/1222))
