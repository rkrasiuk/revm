...
## [6.0.0](https://github.com/rkrasiuk/revm/compare/revm-precompile-v5.1.0...revm-precompile-v6.0.0) - 2024-03-31

### Fixed
- update/enable bn128 tests ([#1242](https://github.com/rkrasiuk/revm/pull/1242))
- use correct bn128 mul input length ([#1238](https://github.com/rkrasiuk/revm/pull/1238))
- use correct rand package for thread_rng ([#1233](https://github.com/rkrasiuk/revm/pull/1233))

### Other
- remove unnecessary call to into_u256() for bn128 add ([#1239](https://github.com/rkrasiuk/revm/pull/1239))
